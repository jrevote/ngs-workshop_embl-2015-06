...
\setWorkshopTitle{Introduction to Next Generation Sequencing Half Day Hands-on Workshop EMBL-Australia PhD Course}
\setWorkshopVenue{Perth}
\setWorkshopDate{June 26, 2015}
\setWorkshopAuthor{
